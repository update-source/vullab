...
ShoppingCart.belongsToMany(ProductItem, {
  through: ShoppingCartItem,
  foreignKey: "cartId",
  otherKey: "productItemId",
  as: "items",
});
ProductItem.belongsToMany(ShoppingCart, {
  through: ShoppingCartItem,
...
ShippingMethod.hasMany(ShopOrder, {
  foreignKey: "shippingMethodId",
  as: "orders",
});
ShopOrder.belongsTo(ShippingMethod, {
  foreignKey: "shippingMethodId",
  as: "shippingMethod",
});
...
Address.hasMany(ShopOrder, {
  foreignKey: "shippingAddressId",
  as: "shippingOrders",
});
ShopOrder.belongsTo(Address, {
  foreignKey: "shippingAddressId",
  as: "shippingAddress",
});
...
ProductItem.hasMany(OrderLine, {
  foreignKey: "productItemId",
  as: "orderLines",
});
OrderLine.belongsTo(ProductItem, {
  foreignKey: "productItemId",
  as: "productItem",
});
