...
const jwtService = {
  ...
  async jwtSecureAuthenticationBypassViaFlawedSignatureVerification(data) {
    const { password, username } = data;
    const existedUser = await User.findOne({ where: { username: username } });
  ...
  async jwtSecureAuthenticationBypassViaWeakSigningKey(data) {
    const { password, username } = data;
    const existedUser = await User.findOne({ where: { username: username } });
  ...
  async jwtSecureAuthenticationBypassViaJwkHeaderInjection(data) {
    const { password, username } = data;
    const existedUser = await User.findOne({ where: { username: username } });
  ...
  async jwtSecureAuthenticationBypassViaKidHeaderInjection(data) {
    const { password, username } = data;
    const existedUser = await User.findOne({ where: { username: username } });
