...
const authController = {
  ...
  async loginSecureIpBlock(req, res, next) {
    try {
      const user = await authService.loginSecureIpBlock(
        req.body,
        req.ip,
        req.useragent,
      );
  ...
  async loginSecureMultipleCredsPerRequest(req, res, next) {
    try {
      const user = await authService.loginSecureMultipleCredsPerRequest(
        req.body,
        req.ip,
        req.useragent,
      );
  ...
  async loginSecureIpLocAccountTracking(req, res, next) {
    try {
      const user = await authService.loginSecureIpLocAccountTracking(
        req.body,
        req.ip,
        req.useragent,
      );
  ...
  async resetSecurePasswordViaPoison(req, res, next) {
    try {
      await authService.resetSecurePasswordViaPoison(req.body);
      return successResponse(res, null, "Password reset successfully");
    } catch (error) {
      next(error);
    }
